<template>
  <div class="wrapper">
    <Carousel class="carousel" v-if="games" v-bind="settings" ref="carousel">
      <Slide class="slide" v-for="game of games" :key="game.id">
        <div class="inner" :style="{ backgroundImage: `url(${game.image})` }">
          <span class="name">
            {{ game.name }}
          </span>
          <div class="info">
            <button class="info__button" @click="playGame">
              {{ t("play") }}
            </button>
    ...
    <button class="button button_prev" @click="prevSlide">
      <svg
        width="32"
        height="32"
        viewBox="0 0 24 24"
    ...
    <button class="button button_next" @click="nextSlide">
      <svg
        width="32"
        height="32"
        viewBox="0 0 24 24"
